...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/HGModulizationDemo/hg_A"
  ...
  s.source       = { :git => "https://github.com/HGModulizationDemo/hg_A.git", :tag => s.version.to_s }
